...
define("_AM_STORYID","شناسه (ID) خبر");
define("_AM_TITLE","عنوان");
define("_AM_TOPIC","سر فصل");
...
define("_AM_RUSUREDEL","آیا اطمینان دارید که می خواهید این خبر و تمام نظر های آن را حذف کنید؟");
define("_AM_YES","بله");
define("_AM_NO","نه");
...
// Added in RC3
define("_AM_ERRORTOPICNAME", "شما باید یک نام برای سر فصل وارد کنید!");
define("_AM_EMPTYNODELETE", "چیزی برای حذف کردن وجود ندارد!");
...
define('_AM_ADD_TOPIC_ERROR','خطا: سر فصل در حال حاضر وجود دارد!');
define('_AM_ADD_TOPIC_ERROR1','خطا: امکان اینکه این سرفصل را به عنوان سر فصل والد قرار داد وجود ندارد');
define('_AM_SUB_MENU','قرار دادن این سر فصل به عنوان یک زیر منو در منوی اصلی');
define('_AM_SUB_MENU_YESNO','زیرمنو؟');
define('_AM_HITS', 'بازدید');
define('_AM_CREATED', 'ساخته شده در');

define('_AM_TOPIC_DESCR', "شرح سر فصل");
...
define('_AM_NEWS_UPGRADEFAILED2', "امکان تغییر طول عنوان سر فصل وجود ندارد");
define('_AM_NEWS_UPGRADEFAILED21', "امکان اضافه کردن فیلد های جدید به جدول سر فصل ها وجود ندارد");
...
define('_AM_NEWS_UPGRADEFAILED0', "لطفا به پیغام ها توجه کنید و سعی نمایید ایرادات را با رفتن به phpMyadmin و sql بر طرف کنید");
define('_AM_NEWS_UPGR_ACCESS_ERROR',"خطا در اجرای فایل آپگرید شما باید مدیر ماژول باشید تا ارتقا انجام شود");
define('_AM_NEWS_PRUNE_BEFORE',"هرس کردن خبر هایی که قبل از این تاریخ در سایت قرار گرفته اند");
define('_AM_NEWS_PRUNE_EXPIREDONLY',"فقط خبر هایی را حذف کن که منقضی شده اند");
define('_AM_NEWS_PRUNE_CONFIRM',"هشدار، شما میخواهید اخباری را که قبل از  %s  منتشر شده اند پاک کنید(البته این کار غیر ممکن نیست). این عمل اخبار %s را نمایان می کند.<br />آیا اطمینان دارید؟");
define('_AM_NEWS_PRUNE_TOPICS',"محدود به سرفصل های زیر");
define('_AM_NEWS_PRUNENEWS', 'هرس کردن خبر ها');
...
define('_AM_NEWS_EXPORT_BETWEEN', 'خروجی گرفتن از خبر های قرار گرفته در سایت بین تاریخ');
define('_AM_NEWS_EXPORT_AND', ' و ');
define('_AM_NEWS_EXPORT_PRUNE_DSC', "اگر هیچکدام را انتخاب نکنید همه سر فصل ها در نظر گرفته می شوند<br/> وگرنه فقط سر فصل های انتخاب شده در نظر گرفته می شوند");
define('_AM_NEWS_EXPORT_INCTOPICS', 'تعریف های سر فصل ها را هم شامل شود؟');
define('_AM_NEWS_EXPORT_ERROR', 'خطا در هنگام ساختن فایل %s. عمل متوقف شد.');
...
define('_AM_NEWS_NEWSLETTER', "خبر نامه");
define('_AM_NEWS_NEWSLETTER_BETWEEN', 'انتخاب خبر های قرار گرفته در سایت بین تاریخ');
define('_AM_NEWS_NEWSLETTER_READY', "فایل خبر نامه برای دانلود آماده است <br /><a href='%s'>بر روی این لینک کلید کنید تا دانلود آغاز شود</a>.<br />فراموش نکنید که بعد از اتمام دانلود <a href='%s'>با کلیک بر روی این لینک آن را حذف کنید</a>");
define('_AM_NEWS_DELETED_OK',"فایل با موفقیت حذف شد");
define('_AM_NEWS_DELETED_PB',"مشکلی در هنگام حذف فایل رخ داد");
define('_AM_NEWS_STATS0','آمار سر فصل ها');
define('_AM_NEWS_STATS','آمار');
define('_AM_NEWS_STATS1','نویسنده  تک خبر');
define('_AM_NEWS_STATS2','همه');
define('_AM_NEWS_STATS3','آمار خبر ها');
define('_AM_NEWS_STATS4','خبر های بیشتر خوانده شده');
define('_AM_NEWS_STATS5','خبر های کمتر خوانده شده');
define('_AM_NEWS_STATS6','خبر های با ارزش بیشتر');
define('_AM_NEWS_STATS7','نویسنده هایی که خبر هایشان بیشتر از همه خوانده شده است');
define('_AM_NEWS_STATS8','نویسنده هایی که خبر هایشان بیشترین ارزش را کسب کرده است');
...
define('_AM_NEWS_NOTHING_PRUNE',"متاسفانه خبری برای پرون شدن وجود ندارد درخواست خود را بررسی کنید");
define('_AM_NEWS_TOPIC_COLOR',"رنگ سرفصل");
define('_AM_NEWS_COLOR',"رنگ");
define('_AM_NEWS_REMOVE_BR',"تبدیل کد های &lt;br&gt; به خط جدید؟");
// Added in 1.3 RC2
define('_AM_NEWS_PLEASE_UPGRADE',"<a href='upgrade.php'><font color='#FF0000'>لطفا در صورتی که ورژن ماژول اخبار شما 1.1 یا 1.2.1 است با زدن بر روی این لینک ماژول را ارتقا دهید !</font></a>");

// Added in verisn 1.50
define('_AM_NEWS_NEWSLETTER_HEADER', "سر صفحه");
define('_AM_NEWS_NEWSLETTER_FOOTER', "پا صفحه");
define('_AM_NEWS_NEWSLETTER_HTML_TAGS', "کد های html  حذف شوند؟");
define('_AM_NEWS_VERIFY_TABLES','تعمیر جدول ها');
define('_AM_NEWS_METAGEN',"موتور متا");
define('_AM_NEWS_METAGEN_DESC',"موتور متا Metagen  سیستمی است که باعث بهتر ایندکس شدن لینک های خبری شما در موتور های جستجو میشود<br />اگر کلمات کلیدی و شرح مطلب را خودتان ننویسید ماژول به طور اوتو ماتیک آنها را مینویسد.");
...
define('_AM_NEWS_META_KEYWORDS_CNT',"حد اکثر تعداد کلمات کلیدی برای ساخته شدن توسط موتور متا به صورت اوتو ماتیک");

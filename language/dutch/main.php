...
define("_NW_POST_SORRY","Sorrie, je beschikt niet over de benodigde rechten om in een onderwerp te posten of er zijn geen onderwerpen."); //but either there are no topics or you don't have the rights to post in any topic
?>
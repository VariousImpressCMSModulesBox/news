...
define("_MB_NEWS_NOTYET","Er is vandaag nog geen biggest artikel.");
...
define("_MB_NEWS_DISP","Toon");
define("_MB_NEWS_ARTCLS","artikelen");
define("_MB_NEWS_CHARS","Lengte van de Titel");
define("_MB_NEWS_LENGTH"," karakters");
define("_MB_TITLE", "Titel");
define("_MB_POSTED", "Gepost");
...
define("_MB_NEWS_IMAGE", "Afbeelding voor Spotlight");
define("_MB_SPOTLIGHT_TOPIC", "Selecteer de categorie(ën) die je hiervoor wilt gebruiken");
define("_MB_SPOTLIGHT_ALL_TOPICS", "Alle categorieën");
define("_MB_NEWS_SPOTLIGHT_ARTICLE", "Selecteer een artikel:");

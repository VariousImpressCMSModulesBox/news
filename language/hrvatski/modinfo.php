...
define("_MI_NEWS_FOOTNOTES","Prikaži linkove u èlanku spremnom za ispis?");
...
define("_MI_NEWS_BOOKMARK_ME","Prikaži 'Oznaèi ovaj èlanak na ove stranice' blok ?");
define("_MI_NEWS_BOOKMARK_ME_DSC","Ovaj blok æe biti vidljiv na stranicama èlanaka");
...
define("_MI_NEWS_ADV_DESCR","Unesite tekst ili javascript kod koji æe se prikazivati u èlancima");
...
define("_MI_NEWS_ENHANCED_PAGENAV_DSC","S ovom opcijom možete odvojiti vaše stranice s neèim kao : [pagebreak:Naslov stranice], linkovi su zamjenjeni sa padajuæom listom i možete koristiti [summary] da bi stvorili automatske sažetak (summary) stranica");

// Added in version 1.54
define('_MI_NEWS_CATEGORY_NOTIFY','Kategorije');
define('_MI_NEWS_CATEGORY_NOTIFYDSC','Obavijest Opcije na Postojecu  Kategoriju/e');

define('_MI_NEWS_CATEGORY_STORYPOSTED_NOTIFY', 'Dostavljena je Nova Vijest');
define('_MI_NEWS_CATEGORY_STORYPOSTED_NOTIFYCAP', 'Obavijesti te me ako u ovoj Kategoriji jedana nova Vijest bude Objavljena.');
define('_MI_NEWS_CATEGORY_STORYPOSTED_NOTIFYDSC', 'Poruku dobiti, ukoliko jedna nova Vijest u Ovoj Kategoriji bude Objavljena.');
define('_MI_NEWS_CATEGORY_STORYPOSTED_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notify : Nova Vijest');
?>
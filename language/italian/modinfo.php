...
define('_MI_NEWS_BNAME4','Notizie più lette');
...
define("_MI_UPLOAD_GROUP1","Chi invia e chi può approvare");
define("_MI_UPLOAD_GROUP2","Solo chi può approvare");
...
define('_MI_RESTRICTINDEXDSC', "Se impostato a sì, gli utenti potranno vedere nell'indice solo le notizie a cui hanno access, come settato in Permessi");

define('_MI_NEWSBYTHISAUTHOR', 'Notizie dello stesso Autore');
define('_MI_NEWSBYTHISAUTHORDSC', "Se impostato a sì, comparirà un link 'Articoli di questo autore'.");

define('_MI_NEWS_PREVNEX_LINK','Mostra link Precedente e Successivo?');
define('_MI_NEWS_PREVNEX_LINK_DESC',"Quando quest'opzione è impostata a 'sì', due nuovi link sono visibili alla fine di ogni articolo. Questi link sono utilizzati per navigare verso l'articolo precedente o successivo in ordine di data");
define('_MI_NEWS_SUMMARY_SHOW','Mostra tabella sommario?');
define('_MI_NEWS_SUMMARY_SHOW_DESC',"Quando usi questa opzione, un sommario contenente link a tutti gli articoli recentemente pubblicati è visibile alla fine di ogni articolo");
...
define('_MI_NEWS_TOPICS_RSS_DESC', "Se imposti questa opzione a 'sì', il contenuto dell'argomento sarà disponibile come RSS Feed");
define('_MI_NEWS_DATEFORMAT', "Formato Data");
define('_MI_NEWS_DATEFORMAT_DESC',"Riferisciti alla documentazione PHP per maggiorin informazioni su come selezionare il formato. Se non inserisci nulla il formato di default sarà utilizzato.");
define('_MI_NEWS_META_DATA', "Permetti di inserire meta data (keywords e description)?");
define('_MI_NEWS_META_DATA_DESC', "Se imposti questa opzione a 'sì', chi approva una notizia potrà inserire i meta dati keyword e description");
...
define("_MI_NEWS_HIGH_COLOR_DES","Usa questa opzione solo se hai scelto 'sì' per la precedente.");
...
define("_MI_NEWS_SITE_NAVBAR_DESC","Se imposti questa opzione a 'sì' i visitatori del tuo sito potranno utilizzare la barra di navigazione per muoversi tra i tuoi articoli.");
define("_MI_NEWS_TABS_SKIN","Scegli la skin da utilizzare nelle cartelle");
define("_MI_NEWS_TABS_SKIN_DESC","Questa skin verrà utilizzata in ogni blocco che usa le cartelle");
...
define("_MI_NEWS_ADVERTISEMENT","Pubblicità");

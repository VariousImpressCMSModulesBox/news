...
define("_MI_NEWS_FF_MICROFORMAT_DSC","For more information, see <a href='http://wiki.mozilla.org/Microsummaries' target='_blank'>this page</a>");
...
define("_MI_NEWS_ADV_DESCR","Enter a text or a javascript code to display in your articles");
...
define("_MI_NEWS_ENHANCED_PAGENAV_DSC","With this option you can separate your pages with something like this : [pagebreak:Page Title], the links to the pages are replaced by a dropdown list and you can use [summary] to create an automatic summary of pages");

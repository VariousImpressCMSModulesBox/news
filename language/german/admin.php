...
define("_AM_ARTPUBLISHED","Ihr Artikel wurde veröffentlicht!");

define("_AM_HELLO","Hallo %s,");

define("_AM_YOURARTPUB","Der von ihnen verfasste Artikel wurde veröffentlicht.");
...
define("_AM_SETEXPDATETIME","Datum/Uhrzeit des Ablaufs: <br>(Nur setzen wenn Artikel nicht ins Archiv soll!<br>Kann/soll meistens frei bleiben)<br>");
...
define("_AM_ADD_TOPIC","Ein Thema zufügen");

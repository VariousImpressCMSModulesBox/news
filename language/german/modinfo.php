...
define("_MI_NEWS_FORM_OPTIONS_DESC","Hier kann gewählt werden welcher Editor zur Eingabe verwand wird. Wurde kein spezieller Editor installiert, kann nur kompakt oder DHTML gewählt werden.");
...
define("_MI_NEWS_TABS_SKIN_DESC","Dieser Skin wird genutzt in allen Blöcken die Tabs nutzen.");

...
class sFiles {
    ...
    function getFileRealName($format="S")
    {
        ...
        switch($format)
        {
        	case "S":
            case "Show":
            	$filerealname=icms_core_DataFilter::htmlSpecialChars($this->filerealname);
				break;
			case "E":
        	case "Edit":
                $filerealname=icms_core_DataFilter::htmlSpecialChars($this->filerealname);
    ...
    function getMimetype($format="S")
    {
       ...
       switch($format){
			case "S":
            case "Show":
                $filemimetype = icms_core_DataFilter::htmlSpecialChars($this->mimetype);
                break;
            case "E":
            case "Edit":
                $filemimetype = icms_core_DataFilter::htmlSpecialChars($this->mimetype);
    ...
    function getDownloadname($format="S")
    {
       ...
       switch($format){
			case "S":
            case "Show":
            	$filedownname = icms_core_DataFilter::htmlSpecialChars($this->downloadname);
                break;
            case "E":
            case "Edit":
                $filedownname = icms_core_DataFilter::htmlSpecialChars($this->downloadname);

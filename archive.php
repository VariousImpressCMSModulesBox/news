...
$xoopsTpl->assign('xoops_pagetitle', icms_core_DataFilter::htmlSpecialChars(_NW_NEWSARCHIVES) . $pgtitle . ' - ' . icms_core_DataFilter::htmlSpecialChars($xoopsModule->getVar("name")));

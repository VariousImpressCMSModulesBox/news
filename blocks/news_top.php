...
function b_news_top_show($options) {
	...
	if(isset($permstory)) {
   	...
   	$block['lang_read_more'] = icms_core_DataFilter::htmlSpecialChars(_MB_READMORE);			// Read More...
   	$block['lang_orderby'] = icms_core_DataFilter::htmlSpecialChars(_MB_NEWS_ORDER);			// "Order By"
   	$block['lang_orderby_date'] = icms_core_DataFilter::htmlSpecialChars(_MB_NEWS_DATE);		// Published date
   	$block['lang_orderby_hits'] = icms_core_DataFilter::htmlSpecialChars(_MB_NEWS_HITS);		// Number of Hits
   	$block['lang_orderby_rating'] = icms_core_DataFilter::htmlSpecialChars(_MB_NEWS_RATE);	// Rating
